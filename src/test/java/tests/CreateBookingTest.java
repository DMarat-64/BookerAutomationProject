...
public class CreateBookingTest {
    ...
    public void setup() {
        ...
        createdBooking.setFirstname("Maik");
        createdBooking.setLastname("Bin");
        createdBooking.setTotalprice(200);
        createdBooking.setDepositpaid(true);
        createdBooking.setBookingdates(new BookingDates("2025-02-12", "2025-02-20"));
